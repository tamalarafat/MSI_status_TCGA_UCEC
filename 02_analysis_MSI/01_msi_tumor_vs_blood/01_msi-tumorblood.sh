...
RESULTSDIR=/pfssmain/departments/pathologie/users/tamyas01/work_dir/sarek/results/sarek_tumorblood
WORKROOT=/pfssmain/departments/pathologie/users/tamyas01/work_dir/sarek
CFG=/pfssmain/departments/pathologie/users/tamyas01/work_dir/sarek/run-sarek.config
PARAMS=/pfssmain/departments/pathologie/users/tamyas01/work_dir/sarek/nf-params.json
